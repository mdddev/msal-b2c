import { Route, RouterFeature, provideRouter, withDisabledInitialNavigation, withEnabledBlockingInitialNavigation, withRouterConfig } from "@angular/router";
...
import { GuardedComponent } from "./app/guarded.component";
